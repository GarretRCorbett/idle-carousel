...
const SCENARIOS := [
	...
	["Green Stick Giant: 2 Wolves, Giraffe", 1, 1.5,
		[[&"mount_slot", 3], [&"wolf", 2], [&"giraffe", 1], [&"wolf_fang", 2], [&"click_damage", 2]]],
	["Yellow Boulder: +Elephant, Wolf T2", 2, 1.5,
		[[&"mount_slot", 4], [&"wolf", 2], [&"giraffe", 1], [&"elephant", 1], [&"wolf_tier2", 1],
		[&"wolf_fang", 4], [&"click_damage", 4]]],
	["Orange Gilded Gale: +Sloth, Giraffe T2", 3, 1.5,
		[[&"mount_slot", 5], [&"wolf", 2], [&"giraffe", 1], [&"elephant", 1], [&"sloth", 1],
		[&"wolf_tier2", 1], [&"giraffe_tier2", 1], [&"wolf_fang", 6], [&"click_damage", 6]]],
	["Red   Ancient Log: Panda build", 4, 1.5,
		[[&"mount_slot", 5], [&"wolf", 2], [&"giraffe", 1], [&"elephant", 1],
		[&"wolf_tier2", 1], [&"giraffe_tier2", 1], [&"elephant_tier2", 1], [&"panda", 1],
		[&"wolf_fang", 8], [&"click_damage", 8]]],
	["Charcoal Obsidian: late build", 5, 1.5,
		[[&"mount_slot", 5], [&"wolf", 2], [&"giraffe", 1], [&"elephant", 1],
		[&"wolf_tier2", 1], [&"giraffe_tier2", 1], [&"elephant_tier2", 1], [&"panda", 1],
		[&"panda_tier2", 1], [&"wolf_fang", 10], [&"click_damage", 10]]],
]
