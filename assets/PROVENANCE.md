...
| `sprites/background/menu_park.png` | [Kenney: Background Elements Remastered](https://kenney.nl/assets/background-elements-remastered) | `Backgrounds/backgroundColorGrass.png` | CC0 1.0 | Renamed; dimmed in the menu scene (replaced menu_fall.png for palette A) | 2026-09-25 |
