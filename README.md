...
| `PHASE_2_GOALS.md` | Phase 2's step checklist and acceptance boxes | Moves to `completed_phases/` at sign-off |
| `completed_phases/` | Finished phase checklists (history) | Rarely |
